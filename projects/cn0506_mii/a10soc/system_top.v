...
module system_top (
  ...
  system_bd i_system_bd (
    ...
    .sys_hps_emac0_gmii_mdo_o_e (hps_emac_mdo_o_e_a),
    .sys_hps_emac0_gmii_mdi_i (hps_emac_mdi_i_a),
    .sys_hps_emac0_md_clk_clk (mdc_fmc_a),
    .sys_hps_emac0_rx_clk_in_clk (mii_rx_clk_a),
    ...
    .sys_hps_emac1_gmii_mdo_o_e (hps_emac_mdo_o_e_b),
    .sys_hps_emac1_gmii_mdi_i (hps_emac_mdi_i_b),
    .sys_hps_emac1_md_clk_clk (mdc_fmc_b),
    .sys_hps_emac1_rx_clk_in_clk (mii_rx_clk_b),
    .sys_hps_emac1_tx_clk_in_clk (mii_tx_clk_b)
    );
